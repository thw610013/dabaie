...
//            questionVO.setHasFavour(questionIdHasFavourMap.getOrDefault(questionVO.getId(), false));
    ...
    ThrowUtils.throwIf(CollUtil.isEmpty(questionIdList), ErrorCode.PARAMS_ERROR,"要删除的题目 Id 不能为空");
        for (Long questionId : questionIdList) {
            ...
            ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR, "删除题目题库关系失败");
